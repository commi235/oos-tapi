...
Handlebars.registerHelper('arrayFilter', function(inputArray, filterProperty, filterValue, negate) {
  var filterValues = filterValue.split(',');
  var returnArray = inputArray.filter( 
    inputValue => { 
      var result = ( filterValues.some( filterVal => inputValue[filterProperty].includes(filterVal)));
      if (negate === 'true') {
        return !result;
      }
      else {
